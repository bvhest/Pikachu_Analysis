...
The Key-Awards are modelled in the Pikachu "PMT" content-type as an Award-element with `AwardType="global_highlight"`
```
...
```
The relation between the two is based on the AwardCode and the Object/id.

The Awards are also included in the product message as Asset-elements in the AssetList-element.
...
The following criteria are defined for starting point of the migration:
...
#### ToDo
  ...
  * describe data-model of awards in STEP,
