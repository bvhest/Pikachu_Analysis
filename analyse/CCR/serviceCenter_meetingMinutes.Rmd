...
| ----------- | ---------------------------------------- | --------- | ----------------- |
| CCR         | Product CTN       | ?        | n.a.              |
| CCR         | Product image     | ?        | n.a.              |
| CCR         | Product description     | ?        | n.a.              |
| CCR         | Product service manuals | ?        | n.a.              |
...
| CCR         | (Siebel) Product manual (DFU)                     | direct link | ?              |
| CCR         | (Siebel) Product Leaflet (PSS)                    | direct link | ?              |
| CCR         | (Siebel) Product support page                     | direct link | ?              |
| CCR         | (Siebel) Product support page (FAQs)              | direct link | ?              |
| CCR         | (Siebel) Product support page (scripts)           | direct link | ?              |


*Note*; the lines with (Siebel) describe data that was used by Siebel. **TODO**: Is it also used by Salesforce?
