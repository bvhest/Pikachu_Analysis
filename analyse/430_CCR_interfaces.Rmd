...
6 | CCR | AEM-PRX | Files | Zip-files with product-care data per locale. Transferred with the SIM-tool (CCR-to-cq5-PRX process)
8 | CCR | PikaChu |  | 
11 | CCR | SDL | Batch | *note: difference with id=2 ?*
66 | CCR | SPOT |  | 
74 | CCR | LCB |  | 
75 | CCR | OLEE |  | 
76 | CCR | DMT |  | 
80 | CCR | Find Your Product |  | 
-- | CCR | Scene7 | files | Publication of (product) video's to Scene7
...
Outbound-interfaces (status onbevestigd):
...
77 | LCB | CCR |  | 
78 | OLEE | CCR |  | 
-- | ACD_SITEL |CCR | files | unknown data to call-center(?) company, delivered with SIM-tool (ACD_SITEL_to_ccr process)

Inbound-interfaces (status onbevestigd):
...
| type    | batch |
| frequency | daily |
| remarks | The product-data required for the leaflets is send from Pikachu (RenderingExport (full & delta)) by using the SIM-tool (pikachu-to-rendering process). |
...
Described in the paragraph "AssetList-export"
