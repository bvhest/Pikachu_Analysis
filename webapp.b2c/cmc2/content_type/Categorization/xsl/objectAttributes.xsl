<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sql="http://apache.org/cocoon/SQL/2.0">
	...
	<xsl:template match="@docStatus|@docTimeStamp|@priority|@preview|@routingCode|@routingName|@sourceLocale|@targetLocale|@translationTagVersion|@workflow"/>
	<!-- -->
	...
	<xsl:template match="Categorization">
		<xsl:copy>
			<xsl:apply-templates select="@*[not(local-name()='lastModified' or local-name()='masterLastModified' or local-name()='type')]"/>
