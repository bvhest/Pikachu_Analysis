...
select lp.ID <!-- ,ll.LANGUAGE, TO_CHAR(lc.sop,'yyyy-mm-dd"T"hh24:mi:ss') as sop, TO_CHAR(lc.eop,'yyyy-mm-dd"T"hh24:mi:ss') as eop, lp.DATA, lc.division -->
from <xsl:value-of select="$table"/> lp
<!--
