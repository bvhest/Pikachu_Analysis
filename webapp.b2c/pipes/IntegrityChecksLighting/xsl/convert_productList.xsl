...
-->
  ...
  <xsl:template match="RESULTSET ">
    <table width="60%" border="1" cellspacing="0" cellpadding="0" align="left" summary="Product count">
       <caption>
         <h2>Product count</h2>
       </caption>
       <tbody>
       <tr>
          ...
          <th width="25%">Product Catalog Count</th> 
       ...
       <xsl:for-each select="RESULT[@name='PikachuProductCount']/ROW">
          ...
          <tr>
             ...
             <td align="right"><xsl:value-of select="../../RESULT[@name='atgProductCount']/ROW[catalog=$v_catalog and localisation=$v_localisation]/atg_count"/></td> 
             <td align="right"><xsl:value-of select="../../sql:rowset[@name='prismaProductCount']/sql:row[sql:catalog=$v_catalog and sql:localisation=$v_localisation]/sql:prisma_count"/></td> 
          </tr>
       </xsl:for-each>
       </tbody>
    </table>
