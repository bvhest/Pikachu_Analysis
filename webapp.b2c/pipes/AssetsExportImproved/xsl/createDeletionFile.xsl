...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cinclude="http://apache.org/cocoon/include/1.0" xmlns:dir="http://apache.org/cocoon/directory/2.0" xmlns:sql="http://apache.org/cocoon/SQL/2.0" xmlns:cmc2-f="http://www.philips.com/cmc2-f" extension-element-prefixes="cmc2-f">
	...
	<xsl:template match="/root/sql:rowset[@name='LOCALE']/sql:row">
		<xsl:variable name="id" select="cmc2-f:escape-scene7-id(sql:object_id)"/>
