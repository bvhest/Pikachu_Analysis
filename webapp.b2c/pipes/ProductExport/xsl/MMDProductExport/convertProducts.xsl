...
<xsl:stylesheet version="2.0" 
  ...
  Author      :  CJ
  Description :  Create IceCatRichContent feed with given XSD format
  ...
  ***************************************************************************
  ...
  <xsl:template match="sql:id|sql:language|sql:sop|sql:eop|sql:sos|sql:eos|sql:priority|sql:content_type|sql:localisation|sql:catalogtype"/>
