...
SELECT    cle.locale, cle.batch, COUNT (o.object_id) number_ctns,
    ...
    left outer JOIN octl o on o.content_type = '<xsl:value-of select="$contentType"/>' and o.localisation =  cle.locale and o.object_id = cle.ctn and o.lastmodified_ts > NVL (cle.lasttransmit, TO_DATE ('1900-01-01', 'yyyy-mm-dd'))
