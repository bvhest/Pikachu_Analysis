...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/root">
    <html>
      <body>
    		<h2>Upload Derived Categorization Content</h2>
    		<form action="{concat($gui_url,$section_url,'derivedcategorization_upload_post')}" method="post" enctype="multipart/form-data">
