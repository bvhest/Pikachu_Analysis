...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <root>
     <sql:execute-query xmlns:sql="http://apache.org/cocoon/SQL/2.0">
      <sql:query name="Process Object Timing">
-- number of objects per unit time per content type
select pl.process_name
     ...
     , pl.runtime_minutes
     , ROUND(pl.object_count_out/pl.runtime_minutes, 1) as object_count_out
     , ROUND( AVG(pl.object_count_out/pl.runtime_minutes)
