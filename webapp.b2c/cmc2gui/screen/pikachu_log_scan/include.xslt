...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cinclude="http://apache.org/cocoon/include/1.0" xmlns:h="http://apache.org/cocoon/request/2.0">
  ...
  <xsl:template match="h:requestParameters">
    <cinclude:include>
      <xsl:attribute name="src" select="concat('cocoon:/pikachulogscan!', $param1,'!', $param2,'!', upper-case(normalize-space(h:parameter[@name='CTN']/h:value)),'!', normalize-space(h:parameter[@name='locale']/h:value),'.xml')"/>
    </cinclude:include>
  </xsl:template>
  <!-- -->
  <!-- -->
