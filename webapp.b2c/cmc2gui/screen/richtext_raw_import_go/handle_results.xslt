            ...
            <html>
              <body>
                ...
                <p>
                  ...
                  <xsl:text>If all files have been uploaded, the next step is to schedule the </xsl:text><xsl:value-of select="$ct"/><xsl:text> and PMT_Enriched content types.
Press the button below, and then on the following page press FIRE NOW</xsl:text><br/><br/><br/>
                  <button>
                    ...
                    <xsl:attribute name="onclick">javascript:window.location='<xsl:value-of select="
                          ...
                          <xsl:text>Schedule RichText load</xsl:text>
                  </button>                       
                  <br/><br/><br/>
                  <hr/>                
              </body>
