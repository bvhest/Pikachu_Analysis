...
function cron() {
    ...
    var param_jobname = cocoon.request.getParameter("job");
    var param_pipename = cocoon.request.getParameter("pipe");
    var param1_jobname = cocoon.request.get("job");
    var param1_pipename = cocoon.request.get("pipe");
    var param_ctn = cocoon.request.getParameter("ctn");  
    var param_locale = cocoon.request.getParameter("locale");    
    var param_usefullpath = cocoon.request.getParameter("usefullpath");      
    ...
    var message = "Main";
    var sleep = "10";
    var pipeline = "pipes/Main/runPipeline";
    var cronexpr = "";
    var intervalexpr = "";
    var atexpr = "";
    var i = 0;

    pipeline = param_pipename;
