...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0">
    ...
    <html>
      ...
      <body contentID="content">
        <div class="philips-body">
          <table border="1">
            <thead>
              <xsl:call-template name="range_ErrorTable"/>
            </thead>
            <tbody>
  ...
  <xsl:template name="range">
    <tr>
      <td valign="top" align="left" width="150px">
        <b>RangeText Preview</b>
        <br/>
      </td>
      <td>
        <a class="one">
          <xsl:attribute name="name">_RangeText</xsl:attribute>
        </a>
        <br/>
        <table>
  ...
  <xsl:template name="range_ErrorTable">
    <tr>
      <td valign="top" align="left" width="150px">
        <b>
          <a class="one">
      ...
      <td>
        <xsl:for-each select="Node">
          ...
          <xsl:call-template name="range_ErrorList"/>
        </xsl:for-each>
      </td>
    </tr>
  </xsl:template>
  <xsl:template name="range_ErrorList">
