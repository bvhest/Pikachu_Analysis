...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.0">
  <!-- -->
  <xsl:import href="xucdm-packagingtext-generic.xsl"/>
  <!-- -->
    ...
    <html>
      ...
      <body contentID="content">
        <div class="philips-body">
          <table border="1">
            <thead>
              <xsl:call-template name="pt_ErrorTable"/>
            </thead>
            <tbody>
              <xsl:call-template name="pt_Packaging"/>
            </tbody>
          </table>
        </div>
      </body>
  ...
  <!-- -->
  <xsl:template name="pt_Packaging">
    <tr>
      ...
      <td>
        <a class="one">
          <xsl:attribute name="name">_PackagingText</xsl:attribute>
        </a>
  ...
  <xsl:template name="pt_ErrorTable">
    <tr>
      <td valign="top" align="left" width="150px">
        <b>
          <a class="one">
      ...
      <td>
        <xsl:for-each select="/PackagingText">
          <a class="one">
            <xsl:attribute name="name">_LengthErrors</xsl:attribute>
          </a>
          <xsl:call-template name="pt_ErrorList"/>
        </xsl:for-each>
      </td>
    </tr>
  </xsl:template>
  <xsl:template name="pt_ErrorList">
